...
MFTENCODER_ENTRY_AUTO(FCC('ULY4'), ULY4);
MFTENCODER_ENTRY_AUTO(FCC('ULH0'), ULH0);
MFTENCODER_ENTRY_AUTO(FCC('ULH2'), ULH2);
MFTENCODER_ENTRY_AUTO(FCC('ULH4'), ULH4);

MFTENCODER_ENTRY_AUTO(FCC('UQY2'), UQY2);
MFTENCODER_ENTRY_AUTO(FCC('UQRG'), UQRG);
MFTENCODER_ENTRY_AUTO(FCC('UQRA'), UQRA);

MFTENCODER_ENTRY_AUTO(FCC('UMRA'), UMRA);
MFTENCODER_ENTRY_AUTO(FCC('UMRG'), UMRG);
MFTENCODER_ENTRY_AUTO(FCC('UMY2'), UMY2);
MFTENCODER_ENTRY_AUTO(FCC('UMY4'), UMY4);
MFTENCODER_ENTRY_AUTO(FCC('UMH2'), UMH2);
MFTENCODER_ENTRY_AUTO(FCC('UMH4'), UMH4);
