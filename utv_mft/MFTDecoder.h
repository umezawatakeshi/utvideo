...
MFTDECODER_ENTRY_AUTO(FCC('ULY4'), ULY4);
MFTDECODER_ENTRY_AUTO(FCC('ULH0'), ULH0);
MFTDECODER_ENTRY_AUTO(FCC('ULH2'), ULH2);
MFTDECODER_ENTRY_AUTO(FCC('ULH4'), ULH4);

MFTDECODER_ENTRY_AUTO(FCC('UQY2'), UQY2);
MFTDECODER_ENTRY_AUTO(FCC('UQRG'), UQRG);
MFTDECODER_ENTRY_AUTO(FCC('UQRA'), UQRA);

MFTDECODER_ENTRY_AUTO(FCC('UMRA'), UMRA);
MFTDECODER_ENTRY_AUTO(FCC('UMRG'), UMRG);
MFTDECODER_ENTRY_AUTO(FCC('UMY2'), UMY2);
MFTDECODER_ENTRY_AUTO(FCC('UMY4'), UMY4);
MFTDECODER_ENTRY_AUTO(FCC('UMH2'), UMH2);
MFTDECODER_ENTRY_AUTO(FCC('UMH4'), UMH4);
