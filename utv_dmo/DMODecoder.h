...
DMODECODER_ENTRY_AUTO(FCC('ULY4'), ULY4);
DMODECODER_ENTRY_AUTO(FCC('ULH0'), ULH0);
DMODECODER_ENTRY_AUTO(FCC('ULH2'), ULH2);
DMODECODER_ENTRY_AUTO(FCC('ULH4'), ULH4);

DMODECODER_ENTRY_AUTO(FCC('UQY0'), UQY0);
DMODECODER_ENTRY_AUTO(FCC('UQY2'), UQY2);
DMODECODER_ENTRY_AUTO(FCC('UQRG'), UQRG);
DMODECODER_ENTRY_AUTO(FCC('UQRA'), UQRA);

DMODECODER_ENTRY_AUTO(FCC('UMRA'), UMRA);
DMODECODER_ENTRY_AUTO(FCC('UMRG'), UMRG);
DMODECODER_ENTRY_AUTO(FCC('UMY2'), UMY2);
DMODECODER_ENTRY_AUTO(FCC('UMY4'), UMY4);
DMODECODER_ENTRY_AUTO(FCC('UMH2'), UMH2);
DMODECODER_ENTRY_AUTO(FCC('UMH4'), UMH4);
