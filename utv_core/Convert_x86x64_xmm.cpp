...
{
	/*
	 * Clang Ç…ÇÕ _mm_undefined_si128 ÇÕñ≥Ç¢ÇÁÇµÇ¢ÅB
	 * Visual C++ Ç≈ÇÕ _mm_setzero_si128 Ç…íuÇ´ä∑Ç¶ÇÁÇÍÇÈÅB
	 * Ç«Ç§ÇπèàóùÇÃëºÇÃïîï™Ç≈ all 0 ÇégÇ§ÇÃÇ≈ÅAÇ±ÇÃèàóùÇ≈Ç‡ñ‚ëËÇ»Ç©ÇÎÇ§ÅB
	 */
