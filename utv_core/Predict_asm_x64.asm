...
; void x64_sse2_PredictLeftAndCount_align1(uint8_t *pDstBegin, const uint8_t *pSrcBegin, const uint8_t *pSrcEnd, uint32_t *pCountTable)
...
; void x64_sse2_PredictMedianAndCount_align16(uint8_t *pDst, const uint8_t *pSrcBegin, const uint8_t *pSrcEnd, uint32_t dwStride, uint32_t *pCountTable)
...
; void x64_sse2_PredictMedianAndCount_align1(uint8_t *pDst, const uint8_t *pSrcBegin, const uint8_t *pSrcEnd, uint32_t dwStride, uint32_t *pCountTable)
...
; void x64_sse1mmx_RestoreMedian_align1(uint8_t *pDst, const uint8_t *pSrcBegin, const uint8_t *pSrcEnd, uint32_t dwStride)
