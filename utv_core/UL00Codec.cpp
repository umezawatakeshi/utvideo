...
size_t CUL00Codec::DecodeFrame(void *pOutput, const void *pInput, utvf_t outfmt, size_t cbGrossWidth)
{
	...
	CalcPlaneSizes(m_nWidth, m_nHeight); // CUL00Codec::CalcStripeMetric() Ç™écîOÇ»Ç™ÇÁôpìôÇ≈Ç»Ç¢ÅiñàÉtÉåÅ[ÉÄåƒÇ‘Ç∆ m_cbPlaneStripeSize Ç™ëùÇ¶ë±ÇØÇÈÅjÇÃÇ≈ÅAÇ∆ÇËÇ†Ç¶Ç∏Ç±Ç±Ç≈ CalcPlaneSizes ÇåƒÇÒÇ≈åÎñÇâªÇ∑
	CalcStripeMetric();
