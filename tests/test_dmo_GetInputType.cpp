...
BOOST_DATA_TEST_CASE(ddmo_GetInputType_encoder, data::make(vecCodecFourcc) ^ data::make(vecSupportedEncoderInputTypes) ^ data::make(vecSupportTemporalCompression), fcc, guids, bTemporalCompression)
{
