...
protected:
	virtual DWORD GetOutputFCC(void) { return FCC('UAY2'); }
	...
	virtual void SetCompressionProperty(const BITMAPINFOHEADER *pbihIn, const BITMAPINFOHEADER *pbihOut);
};
